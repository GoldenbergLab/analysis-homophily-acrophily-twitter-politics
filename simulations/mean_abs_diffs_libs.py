...
# Setting number of simulation trials:
n = 100
...
# Saving pickle file in data folder:
with open('../data/mean_abs_diffs_'+str(range_start)+'_'+str(range_end)+'_.pickle', 'wb') as handle:
    pickle.dump(baseline, handle, protocol=pickle.HIGHEST_PROTOCOL)

# Confirmation print statement for grid:
