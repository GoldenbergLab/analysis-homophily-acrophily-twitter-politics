...
df <- df[,c('tweet', 'avg_libcons_left', 'avg_libcons_right', 'avg_libcons_ml', 'avg_libcons_mr', 'avg_feel_left', 'avg_feel_right', 'avg_feel_ml', 'avg_feel_mr', 'viewed_all')]
...
# Saving result:
write.csv(df_long, '../data/strategic_signaling_data_long_no_moderates.csv', row.names=FALSE)
```
