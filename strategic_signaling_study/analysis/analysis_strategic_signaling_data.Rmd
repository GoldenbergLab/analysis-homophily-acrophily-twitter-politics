...
# Reading in data
df <- read.csv("../data/strategic_signaling_data_long_no_moderates.csv")
...
co_gen_model_coded <- lm(avg_sentiment ~scale(avg_perceived)*poli_affil_coded + viewed_all, data=df_co_gen)
...
# Model with interaction between perceived copartisanship and political affiliation:
co_gen_model_left <- lm(avg_sentiment ~scale(avg_perceived)*poli_affil + viewed_all, data=df_co_gen)
...
# Model with interaction between perceived copartisanship and political affiliation:
co_gen_model_right <- lm(avg_sentiment ~scale(avg_perceived)*poli_affil + viewed_all, data=df_co_gen)
...
# Model with interaction between perceived copartisanship and political affiliation:
co_mod_model_coded <- lm(avg_sentiment ~scale(avg_perceived)*poli_affil_coded + viewed_all, data=df_co_mod)
