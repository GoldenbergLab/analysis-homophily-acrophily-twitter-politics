...
co_gen_model_left <- lm(avg_sentiment ~avg_perceived*poli_affil, data=df_co_gen)
...
# Model with interaction between perceived copartisanship and political affiliation:
co_gen_model_right <- lm(avg_sentiment ~avg_perceived*poli_affil, data=df_co_gen)
...
# Model with interaction between perceived copartisanship and political affiliation:
co_gen_model_coded <- lm(avg_sentiment ~avg_perceived*poli_affil_coded, data=df_co_gen)
...
# Model with interaction between perceived copartisanship and political affiliation:
co_mod_model_left <- lm(avg_sentiment ~avg_perceived*poli_affil, data=df_co_mod)
...
# Model with interaction between perceived copartisanship and political affiliation:
co_mod_model_right <- lm(avg_sentiment ~avg_perceived*poli_affil, data=df_co_mod)
...
# Model with interaction between perceived copartisanship and political affiliation:
co_mod_model_coded <- lm(avg_sentiment ~avg_perceived*poli_affil_coded, data=df_co_mod)
...
# Model with interaction between perceived copartisanship and political affiliation:
cross_gen_model_left <- lm(avg_sentiment ~avg_perceived*poli_affil, data=df_cross_gen)
...
# Model with interaction between perceived copartisanship and political affiliation:
cross_gen_model_right <- lm(avg_sentiment ~avg_perceived*poli_affil, data=df_cross_gen)
...
# Model with interaction between perceived copartisanship and political affiliation:
cross_gen_model_coded <- lm(avg_sentiment ~avg_perceived*poli_affil_coded, data=df_cross_gen)
...
# Model with interaction between perceived copartisanship and political affiliation:
cross_mod_model_left <- lm(avg_sentiment ~avg_perceived*poli_affil, data=df_cross_mod)
...
# Model with interaction between perceived copartisanship and political affiliation:
cross_mod_model_right <- lm(avg_sentiment ~avg_perceived*poli_affil, data=df_cross_mod)
...
# Model with interaction between perceived copartisanship and political affiliation:
cross_mod_model_coded <- lm(avg_sentiment ~avg_perceived*poli_affil_coded, data=df_cross_mod)
